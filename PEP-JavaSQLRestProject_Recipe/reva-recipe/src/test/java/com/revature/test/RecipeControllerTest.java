...
public class RecipeControllerTest {
    ...
    // @Test
    // public void testGetRecipesWithIngredientName() throws Exception {
    //     RecipeService recipeService = mock(RecipeService.class);
    //     AuthenticationService authService = mock(AuthenticationService.class);
    //     List<Recipe> mockResults = Collections.singletonList(new Recipe("Pizza"));
    //     when(recipeService.searchRecipesByIngredient("cheese")).thenReturn(mockResults);

    //     Context ctx = mock(Context.class);
    //     when(ctx.queryParam("ingredient")).thenReturn("cheese");
    ...
    // @Test
    // public void testGetRecipesWithIngredientAndRecipeName() throws Exception {
    //     RecipeService recipeService = mock(RecipeService.class);
    //     AuthenticationService authService = mock(AuthenticationService.class);
    //     List<Recipe> mockResults = Collections.singletonList(new Recipe("Veggie Pizza"));
    //     when(recipeService.searchRecipesByIngredientAndName("Pizza", "brocolli")).thenReturn(mockResults);

    //     Context ctx = mock(Context.class);        
    //     when(ctx.queryParam("name")).thenReturn("Pizza");
    //     when(ctx.queryParam("ingredient")).thenReturn("brocolli");
