...
public class RecipeServiceTest {
    ...
    // @Test
    // void searchForFilteredListOfRecipesByIngredient() {
    //     when(recipeDao.searchRecipesByIngredient("lettuce")).thenReturn(Arrays.asList(MOCKS.get(3), MOCKS.get(4)));
    //     List<Recipe> recipes = recipeService.searchRecipesByIngredient("lettuce");
    //     assertIterableEquals(Arrays.asList(MOCKS.get(3), MOCKS.get(4)), recipes, () -> "Recipes should match");
    // }

    // @Test
    // void searchForFilteredListOfRecipesByIngredientAndName() {
    //     when(recipeDao.searchRecipesByIngredientAndName("Salad", "lettuce")).thenReturn(Arrays.asList(MOCKS.get(3)));
    //     List<Recipe> recipes = recipeService.searchRecipesByIngredientAndName("Salad", "lettuce");
    //     assertIterableEquals(Arrays.asList(MOCKS.get(3)), recipes, () -> "Recipes should match");
    // }
